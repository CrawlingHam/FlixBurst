...
export const PrivacyPolicy: React.FC<TermsAndConditionsProps> = ({
  onGoBack,
  onSupport,
}) => {
  return (
    <div className="min-h-screen bg-gray-50 p-8 ">
      ...
      <p className="mb-4 text-gray-600">Effective: October 29, 2024</p>
      ...
      <h3 className="mb-3 text-xl font-medium text-gray-800">Interpretation</h3>
      <p className="mb-6 text-gray-700">
      ...
      <h3 className="mb-3 text-xl font-medium text-gray-800">Definitions</h3>
      ...
      <ul className="list-inside list-disc space-y-3 text-gray-700">
        ...
        <li>
          <strong>Application</strong>: refers to Fortnite123, the software
        ...
        <li>
          <strong>Third-party Social Media Service</strong>: any social network
      ...
      {/* Personal Data */}
      <h4 className="mb-2 text-lg font-medium text-gray-800">Personal Data</h4>
      <p className="mb-4 text-gray-700">
      ...
      {/* Usage Data */}
      <h4 className="mb-2 text-lg font-medium text-gray-800">Usage Data</h4>
      <p className="mb-6 text-gray-700">
      ...
      <ul className="mb-6 list-inside list-disc space-y-3 text-gray-700">
        ...
        <li>
          <span className="mx-1 font-bold"> To manage Your Account:</span> to
        ...
        <li>
          <span className="mx-1 font-bold"> To contact You:</span> To contact
        ...
        <li>
          <span className="mx-1 font-bold"> To provide You with news</span>,
        ...
        <li>
          <span className="mx-1 font-bold"> To manage Your requests:</span> To
          attend and manage Your requests to Us.
        </li>
        <li>
          <span className="mx-1 font-bold"> For business transfers:</span> We
        ...
        <li>
          <span className="mx-1 font-bold"> For other purposes:</span> We may
      ...
      <ul className="mb-6 list-inside list-disc space-y-3 text-gray-700">
        <li>
          <span className="mx-1 font-bold">With Service Providers:</span>We may
          share Your personal information with Service Providers to monitor and
          analyze the use of our Service, to contact You.
        </li>
        <li>
          <span className="mx-1 font-bold">For business transfers:</span>We may
        ...
        <li>
          <span className="mx-1 font-bold">With Affiliates:</span>We may share
        ...
        <li>
          <span className="mx-1 font-bold">With business partners:</span>We may
          share Your information with Our business partners to offer You certain
          products, services or promotions.
        </li>
        <li>
          <span className="mx-1 font-bold">With other users</span>when You share
        ...
        <li>
          <span className="mx-1 font-bold">With Your consent:</span>We may
