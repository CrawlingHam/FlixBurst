...
export const TermsAndConditions: React.FC<TermsAndConditionsProps> = ({
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <p className="mb-4 text-gray-700">Last updated: October 29, 2024</p>
      ...
      <h3 className="mb-2 text-2xl font-semibold text-gray-800">Definitions</h3>
      <p className="mb-4 text-gray-700">
      ...
      <ul className="list-disc space-y-4 pl-6">
        <li>
          <p className="text-gray-700">
            ...
            "Us" or "Our" in this Agreement) refers to Flixburst.
          </p>
        </li>
        <li>
          <p className="text-gray-700">
      ...
      <p className="mb-6 text-gray-700">
        Please{' '}
        <span
          className="mx-1 font-bold hover:cursor-pointer hover:underline "
          onClick={onSupport}
        >
          contact support
        </span>{' '}
      ...
      <button
        onClick={onGoBack}
        className="mt-4 rounded bg-blue-600 px-4 py-2 font-semibold text-white shadow transition duration-300 hover:bg-blue-700"
      >
        Go Back
      </button>
    </div>
