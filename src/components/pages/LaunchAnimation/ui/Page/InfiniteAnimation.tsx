...
export const InfiniteLaunchAnimation = () => {
  useEffect(() => {
  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1422 800">
      <defs>
        <linearGradient x1="50%" y1="10%" x2="50%" y2="100%" id="oooscillate-grad">
          <stop className="color-stop1" stop-color="hsl(206, 75%, 49%)" stop-opacity="1" offset="30%"></stop>
          <stop className="color-stop2" stop-color="hsl(500, 90%, 56%)" stop-opacity="1" offset="100%"></stop>
        </linearGradient>
      </defs>

      {/* Mirrored Paths */}
      <g id="mirrored" stroke-width="1" stroke="url(#oooscillate-grad)" fill="none" stroke-linecap="round">
      ...
      {/* Unmirrored Paths */}
      <g id="unmirrored" stroke-width="1" stroke="url(#oooscillate-grad)" fill="none" stroke-linecap="round">
